    ...
    return (
        <>
            <Routes>
                ...
                <Route path="list-endereco-cliente" element={<ProtectedRoute><ListEnderecoCliente /></ProtectedRoute>} />
                ...
                <Route path="list-categoria" element={<ProtectedRoute><ListCatgoriaProduto /></ProtectedRoute>} />
